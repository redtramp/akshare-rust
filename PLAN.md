...
| Rust 已实现并验证函数数 | **80**（`cargo check` 全绿，非 stub）|
| 整体覆盖率 | **≈ 7.3%** |
...
| fund | 5 | 74 | 6.8% |
| index | 3 | 79 | 3.8% |
| stock_feature | 36 | 211 | 17.1% |

**完全未覆盖大类（0%）：** economic(226)、stock_feature(余 175)、futures(70)、stock_fundamental(57)、option(47)、bond(46)，以及其余长尾 24 类（spot/futures_derivative/movie/energy/currency/news/fx/fortune/cal/qdii/reits/event/forex/crypto/rate/nlp/tool/hf/interest_rate/bank/pro/other/article/air/qhkc_web）全部为 0。
