...
CASES: list[tuple[str, list[str], str, str]] = [
    ...
    ("stock_board_industry_spot_em", ["小金属"], "loose", "行业板块实时行情"),
    ("stock_board_concept_spot_em", ["可燃冰"], "loose", "概念板块实时行情"),
    ("stock_board_industry_hist_min_em", ["小金属", "5"], "loose", "行业板块分钟行情"),
    ("stock_board_concept_hist_min_em", ["长寿药", "5"], "loose", "概念板块分钟行情"),
    ...
    ("stock_individual_fund_flow_rank", ["今日"], "loose", "个股资金流排行"),
    ("stock_market_fund_flow", [], "loose", "大盘资金流"),
    ("stock_main_fund_flow", ["全部股票"], "loose", "主力净流入排名"),
    ("stock_sector_fund_flow_rank", ["今日", "行业资金流"], "loose", "板块资金流排名"),
    ("stock_sector_fund_flow_hist", ["汽车服务"], "loose", "行业历史资金流"),
    ("stock_sector_fund_flow_summary", ["电源设备", "今日"], "loose", "行业个股资金流"),
    ("stock_concept_fund_flow_hist", ["数据要素"], "loose", "概念历史资金流"),
    ...
    ("index_global_spot_em", [], "loose", "东财全球指数实时"),
    ("index_global_hist_em", ["美元指数"], "loose", "东财全球指数历史"),
    ("index_stock_cons_sina", ["000300"], "loose", "新浪指数成分股"),
    ("index_stock_info", [], "loose", "聚宽指数列表"),
    ("index_stock_cons_csindex", ["000300"], "loose", "中证指数成分股"),
    ("index_stock_cons_weight_csindex", ["000300"], "loose", "中证指数权重"),
    ("index_global_name_table", [], "loose", "新浪全球指数名称表"),
    ("index_global_hist_sina", ["日经225指数"], "loose", "新浪全球指数历史"),
    ("index_all_cni", [], "loose", "国证指数列表"),
    ("index_hist_cni", ["399001", "20230114", "20240114"], "loose", "国证指数历史行情"),
    ("index_detail_cni", ["399001"], "loose", "国证指数样本成份"),
    ("index_detail_hist_cni", ["399001"], "loose", "国证指数历史样本"),
    ("index_detail_hist_adjust_cni", ["399005"], "loose", "国证指数历史调样"),
    ("index_hist_sw", ["801030", "day"], "loose", "申万指数历史"),
    ("index_hist_fund_sw", ["807200", "day"], "loose", "申万基金指数历史"),
    ("index_component_sw", ["801001"], "loose", "申万指数成分股"),
    ("index_min_sw", ["801001"], "loose", "申万指数分时"),
    ("index_realtime_sw", ["二级行业"], "loose", "申万指数实时"),
    ("index_analysis_daily_sw", ["市场表征", "20221103", "20221103"], "loose", "申万指数分析日报"),
    ("index_analysis_weekly_sw", ["市场表征", "20221001", "20221103"], "loose", "申万指数分析周报"),
    ("index_analysis_monthly_sw", ["市场表征", "20220901", "20221103"], "loose", "申万指数分析月报"),
    ("index_analysis_week_month_sw", ["month"], "loose", "申万周/月日期序列"),
    ("index_pmi_com_cx", [], "loose", "财新综合PMI"),
    ("index_pmi_man_cx", [], "loose", "财新制造业PMI"),
    ("index_pmi_ser_cx", [], "loose", "财新服务业PMI"),
    ("index_dei_cx", [], "loose", "财新数字经济指数"),
    ("index_ii_cx", [], "loose", "财新产业指数"),
    ("index_si_cx", [], "loose", "财新溢出指数"),
    ("index_fi_cx", [], "loose", "财新融合指数"),
    ("index_bi_cx", [], "loose", "财新基础指数"),
    ("index_nei_cx", [], "loose", "财新中国新经济指数"),
    ("index_li_cx", [], "loose", "财新劳动力投入指数"),
    ("index_ci_cx", [], "loose", "财新资本投入指数"),
    ("index_ti_cx", [], "loose", "财新科技投入指数"),
    ("index_neaw_cx", [], "loose", "财新新经济行业入职平均工资"),
    ("index_awpr_cx", [], "loose", "财新新经济入职工资溢价"),
    ("index_cci_cx", [], "loose", "财新大宗商品指数"),
    ("index_qli_cx", [], "loose", "财新高质量因子指数"),
    ("index_ai_cx", [], "loose", "财新AI策略指数"),
    ("index_bei_cx", [], "loose", "财新基石经济指数"),
    ("index_neei_cx", [], "loose", "财新新动能指数"),
    ("index_csindex_all", [], "loose", "中证指数列表"),
    ("index_sugar_msweet", [], "loose", "中国食糖指数"),
    ("index_price_cflp", ["周指数"], "loose", "公路物流运价指数"),
    ...
    ("fund_open_fund_rank_em", ["全部"], "loose", "开放基金排行"),
    ("fund_exchange_rank_em", [], "loose", "场内交易基金排行"),
    ("fund_money_rank_em", [], "loose", "货币型基金排行"),
    ("fund_lcx_rank_em", [], "loose", "理财基金排行"),
    ("fund_open_fund_daily_em", [], "loose", "开放式基金净值"),
    ("fund_money_fund_daily_em", [], "loose", "货币型基金净值"),
    ("fund_financial_fund_daily_em", [], "loose", "理财型基金收益"),
    ("fund_fh_em", ["2025", "", "BZDM", "asc", "-1"], "loose", "基金分红"),
    ("fund_cf_em", ["2025", "", "FSRQ", "desc", "-1"], "loose", "基金拆分"),
    ("fund_name_em", [], "loose", "基金名称和类型"),
    ...
    ("fund_rating_all", [], "loose", "基金评级总汇"),
    ("fund_rating_sh", ["20230630"], "loose", "上海证券评级"),
    ("fund_rating_zs", ["20230331"], "loose", "招商证券评级"),
    ("fund_rating_ja", ["20230331"], "loose", "济安金信评级"),
    ("fund_announcement_dividend_em", ["000001"], "loose", "基金公告-分红配送"),
    ("fund_announcement_report_em", ["000001"], "loose", "基金公告-定期报告"),
    ("fund_announcement_personnel_em", ["000001"], "loose", "基金公告-人事调整"),
    ("fund_aum_em", [], "loose", "基金公司排名"),
    ("fund_aum_hist_em", ["2023"], "loose", "基金公司历年规模"),
    ...
    ("fund_scale_open_sina", ["股票型基金"], "loose", "新浪开放式基金规模"),
    ("fund_scale_close_sina", [], "loose", "新浪封闭式基金规模"),
    ...
    ("stock_industry_change_cninfo", ["002594", "20091227", "20220713"], "loose", "巨潮行业归属变动"),
    ("stock_industry_pe_ratio_cninfo", ["20230817"], "loose", "巨潮行业市盈率"),
    ("stock_rank_forecast_cninfo", ["20230817"], "loose", "巨潮个股研报预测"),
    ("stock_share_change_cninfo", ["002594", "20091227", "20241021"], "loose", "巨潮股本变动"),
    # === BATCH36-B cninfo 专题统计（股东股本/公司治理/配股） ===
    ("stock_hold_num_cninfo", ["20210630"], "loose", "巨潮股东人数及持股集中度"),
    ("stock_cg_equity_mortgage_cninfo", ["20210930"], "loose", "巨潮股权质押"),
    ("stock_cg_guarantee_cninfo", ["全部", "20180630", "20210927"], "loose", "巨潮对外担保"),
    ("stock_cg_lawsuit_cninfo", ["全部", "20180630", "20210927"], "loose", "巨潮公司诉讼"),
    ("stock_hold_control_cninfo", ["全部"], "loose", "巨潮公司控制权"),
    ("stock_hold_change_cninfo", ["全部"], "loose", "巨潮股本变动"),
    ("stock_hold_management_detail_cninfo", ["增持"], "loose", "巨潮董监高持股变动明细"),
    ("stock_allotment_cninfo", ["600030", "19700101", "22220222"], "loose", "巨潮配股实施方案"),
    ...
    ("stock_info_sh_name_code", ["主板A股"], "loose", "上交所股票列表"),
    ("stock_info_sh_delist", ["全部"], "loose", "上交所终止上市公司"),
    ("stock_info_bj_name_code", [], "loose", "北交所股票列表"),
    ("stock_hk_famous_spot_em", [], "loose", "知名港股实时行情"),
    ("stock_us_famous_spot_em", ["科技类"], "loose", "知名美股实时行情"),
    ("stock_zh_a_spot_tx", [], "loose", "腾讯沪深京实时行情"),
    ("stock_zh_a_stop_em", [], "loose", "东财两网及退市"),
    ("stock_zh_a_new", [], "loose", "新浪次新股"),
    ("stock_zh_a_daily", ["sh600519", "20240101", "20240201", ""], "strict", "新浪A股日线"),
    ("stock_us_pink_spot_em", [], "loose", "东财粉单市场行情"),
    ("stock_zh_ah_spot_em", [], "loose", "东财AH股比价行情"),
    ("stock_zh_ah_spot", [], "loose", "腾讯AH实时行情"),
    ("stock_zh_ah_name", [], "loose", "腾讯AH股票名称"),
    ("stock_zh_ah_daily", ["02318", "2024", "2025", ""], "strict", "腾讯AH历史行情"),
    ("stock_hsgt_sh_hk_spot_em", [], "loose", "东财港股通沪港股票"),
    ("stock_zh_a_spot", [], "loose", "新浪A股全量行情"),
    ("stock_irm_cninfo", ["002594"], "loose", "巨潮互动易提问"),
    ("stock_irm_ans_cninfo", ["1513586704097333248"], "loose", "巨潮互动易回答"),
    ("stock_info_sz_name_code", ["A股列表"], "loose", "深交所股票列表"),
    ("stock_info_sz_delist", ["终止上市公司"], "loose", "深交所终止上市公司"),
    ("stock_info_sz_change_name", ["全称变更"], "loose", "深交所名称变更"),
    ("stock_info_change_name", ["000503"], "loose", "新浪股票曾用名"),
    ("stock_info_a_code_name", [], "loose", "沪深京A股列表"),
    ("stock_report_disclosure", ["沪深京", "2021年报"], "loose", "巨潮预约披露"),
    ("stock_zh_a_cdr_daily", ["sh689009", "20240101", "20240201"], "strict", "新浪CDR日线"),
    ("stock_szse_summary", ["20240830"], "loose", "深交所证券类别统计"),
    ("stock_szse_area_summary", ["202203"], "loose", "深交所地区交易排序"),
    ("stock_sse_summary", [], "loose", "上交所总貌"),
    ("stock_sse_deal_daily", ["20241216"], "loose", "上交所每日股票情况"),
    ("stock_zh_b_daily", ["sh900901", "20240101", "20240201", ""], "strict", "新浪B股日线"),
    ("stock_zh_b_minute", ["sh900901", "5", ""], "strict", "新浪B股分钟线"),
    ("stock_hk_daily", ["00981", ""], "loose", "新浪港股日线"),
    ("stock_sector_spot", ["新浪行业"], "loose", "新浪行业板块行情"),
    ("stock_sector_detail", ["gn_gfgn"], "loose", "新浪板块成份详情"),
    ("stock_zh_a_tick_tx_js", ["sz000001"], "loose", "腾讯历史分笔"),
    ("stock_intraday_sina", ["sz000001", "20240321"], "loose", "新浪日内分时"),
    ("stock_staq_net_stop", [], "loose", "东财两网及退市"),
    ("stock_intraday_em", ["000001"], "loose", "东财分时数据"),
    ("stock_news_main_cx", [], "loose", "财新数据通新闻"),
    ("stock_zh_a_disclosure_report_cninfo", ["000001", "沪深京", "", "", "20230618", "20231219"], "loose", "巨潮信息披露公告"),
    ("stock_zh_a_disclosure_relation_cninfo", ["000001", "沪深京", "20230618", "20231219"], "loose", "巨潮预约披露调研"),
    ("stock_hot_search_baidu", ["A股", "20250616", "今日"], "loose", "百度股市通热搜"),
    ("stock_js_weibo_report", ["CNHOUR12"], "loose", "金十微博舆情报告"),
    ("stock_js_weibo_nlp_time", [], "loose", "金十微博舆情时间档"),
    ("stock_price_js", ["us"], "loose", "美港股目标价"),
    ("stock_hk_fhpx_detail_ths", ["0700"], "loose", "同花顺港股分红"),
    ("get_us_stock_name", [], "loose", "新浪美股代码名称"),
    ("stock_us_spot", [], "loose", "新浪美股全量行情"),
    ("stock_us_daily", ["FB", ""], "strict", "新浪美股日线"),
    ("stock_zh_kcb_daily", ["sh688399", ""], "loose", "新浪科创板日线"),
    ("stock_zh_kcb_spot", [], "loose", "新浪科创板行情"),
    ("stock_zh_b_spot", [], "loose", "新浪B股行情"),
    ("stock_share_hold_change_sse", ["全部"], "loose", "上交所董监高股份变动"),
    ("stock_share_hold_change_szse", ["全部"], "loose", "深交所董监高股份变动"),
    ("stock_share_hold_change_bse", ["430489"], "loose", "北交所董监高股份变动"),
    ...
    ("stock_hk_hot_rank_em", [], "loose", "港股个股人气榜"),
    ("stock_hk_hot_rank_detail_em", ["00700"], "loose", "港股人气历史趋势"),
    ("stock_hk_hot_rank_detail_realtime_em", ["00700"], "loose", "港股人气实时变动"),
    ("stock_hk_hot_rank_latest_em", ["00700"], "loose", "港股人气最新排名"),
    ...
    ("stock_profit_sheet_by_quarterly_em", ["SH600519"], "loose", "利润表-按单季度(emweb F10)"),
    ("stock_cash_flow_sheet_by_quarterly_em", ["SH600519"], "loose", "现金流量表-按单季度(emweb F10)"),
    ("stock_balance_sheet_by_report_delisted_em", ["SZ000013"], "loose", "资产负债表-已退市(emweb datacenter)"),
    ("stock_profit_sheet_by_report_delisted_em", ["SZ000013"], "loose", "利润表-已退市(emweb datacenter)"),
    ("stock_cash_flow_sheet_by_report_delisted_em", ["SZ000013"], "loose", "现金流量表-已退市(emweb datacenter)"),
    ...
    ("macro_china_central_bank_balance", [], "loose", "央行货币当局资产负债"),
    ("macro_china_foreign_exchange_gold", [], "loose", "外汇和黄金储备"),
    ("macro_china_insurance", [], "loose", "保险业经营情况"),
    ("macro_china_international_tourism_fx", [], "loose", "国际旅游外汇收入"),
    ("macro_china_passenger_load_factor", [], "loose", "民航客运量及客座率"),
    ("macro_china_postal_telecommunicational", [], "loose", "邮电业务量"),
    ("macro_china_retail_price_index", [], "loose", "商品零售价格指数"),
    ("macro_china_society_electricity", [], "loose", "全社会用电量"),
    ("macro_china_society_traffic_volume", [], "loose", "全社会客货运输量"),
    ("macro_china_supply_of_money", [], "loose", "货币供应量"),
    ("macro_china_freight_index", [], "loose", "运输生产指数"),
    ("macro_china_shrzgm", [], "loose", "社会融资规模增量"),
    ("macro_china_bond_public", [], "loose", "债券发行"),
    ("macro_china_swap_rate", ["20231101", "20231204"], "loose", "FR007利率互换曲线"),
    ("macro_euro_gdp_yoy", [], "loose", "欧元区季度GDP年率"),
    ("macro_euro_cpi_mom", [], "loose", "欧元区CPI月率"),
    ("macro_euro_cpi_yoy", [], "loose", "欧元区CPI年率"),
    ("macro_euro_ppi_mom", [], "loose", "欧元区PPI月率"),
    ("macro_euro_retail_sales_mom", [], "loose", "欧元区零售销售月率"),
    ("macro_euro_employment_change_qoq", [], "loose", "欧元区季调后就业人数季率"),
    ("macro_euro_unemployment_rate_mom", [], "loose", "欧元区失业率"),
    ("macro_euro_trade_balance", [], "loose", "欧元区未季调贸易帐"),
    ("macro_euro_current_account_mom", [], "loose", "欧元区经常帐"),
    ("macro_euro_industrial_production_mom", [], "loose", "欧元区工业产出月率"),
    ("macro_euro_manufacturing_pmi", [], "loose", "欧元区制造业PMI初值"),
    ("macro_euro_services_pmi", [], "loose", "欧元区服务业PMI终值"),
    ("macro_euro_zew_economic_sentiment", [], "loose", "欧元区ZEW经济景气指数"),
    ("macro_euro_sentix_investor_confidence", [], "loose", "欧元区Sentix投资者信心指数"),
    ("macro_euro_lme_holding", [], "loose", "LME持仓报告"),
    ("macro_euro_lme_stock", [], "loose", "LME库存报告"),
    ...
    # === 批次36 fx/forex/reits/tool/news 可达函数 ===
    ("fx_quote_baidu", ["人民币", ""], "loose", "百度外汇行情榜单(无token返回空)"),
    ("forex_spot_em", [], "loose", "东财外汇实时行情"),
    ("forex_hist_em", ["USDCNH"], "loose", "东财外汇历史行情"),
    ("reits_realtime_em", [], "loose", "东财REITs实时行情"),
    ("reits_hist_em", ["508097"], "loose", "东财REITs历史行情"),
    ("reits_hist_min_em", ["508097"], "loose", "东财REITs分时行情"),
    ("tool_trade_date_hist_sina", [], "strict", "新浪交易日历"),
    ("stock_news_em", ["603777"], "loose", "东财个股新闻"),
    # spot - 搜猪网
